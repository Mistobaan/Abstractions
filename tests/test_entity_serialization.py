...
from abstractions.ecs.entity import (
    ...
    EntityRegistry,
    EntityTree,
    EntityWithContainersOfPrimitives,
    EntityWithMixedContainers,
    EntityWithNestedContainers,
...
class TestEntitySerialization(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.dict_entity.entities = {"key1": Entity(), "key2": Entity()}
        ...
        self.container_primitive_entity.root_ecs_id = (
            self.container_primitive_entity.ecs_id
        )
        self.container_primitive_entity.root_live_id = (
            self.container_primitive_entity.live_id
        )
        ...
        self.mixed_container_entity.mixed_list = [
            mixed_list_entity1,
            mixed_list_entity2,
        ]
        ...
        self.base_model_entity.base_model.entity.root_ecs_id = (
            self.base_model_entity.ecs_id
        )
        self.base_model_entity.base_model.entity.root_live_id = (
            self.base_model_entity.live_id
        )
        ...
        for entity_field in [
            ...
            if hasattr(entity_field, "entity_of_entity"):
                ...
                if hasattr(entity_field.entity_of_entity, "sub_entity"):
                    entity_field.entity_of_entity.sub_entity.root_ecs_id = (
                        self.hierarchical.ecs_id
                    )
                    entity_field.entity_of_entity.sub_entity.root_live_id = (
                        self.hierarchical.live_id
                    )
    ...
    def test_nested_entity_serialization(self):
        ...
        self.assertEqual(
            new_entity.sub_entity.root_ecs_id, self.nested.sub_entity.root_ecs_id
        )
        self.assertEqual(
            new_entity.sub_entity.root_live_id, self.nested.sub_entity.root_live_id
        )
    ...
    def test_list_entity_serialization(self):
        ...
        for i, entity in enumerate(new_entity.entities):
            ...
            self.assertEqual(
                entity.root_ecs_id, self.list_entity.entities[i].root_ecs_id
            )
            self.assertEqual(
                entity.root_live_id, self.list_entity.entities[i].root_live_id
            )
    ...
    def test_dict_entity_serialization(self):
        ...
        for key, entity in new_entity.entities.items():
            ...
            self.assertEqual(
                entity.root_ecs_id, self.dict_entity.entities[key].root_ecs_id
            )
            self.assertEqual(
                entity.root_live_id, self.dict_entity.entities[key].root_live_id
            )
    ...
    def test_complex_entity_serialization(self):
        ...
        root.entity_of_entity_of_entity.entity_of_entity.sub_entity.untyped_data = (
            "Modified deep entity"
        )
    ...
    def test_entity_tree_serialization(self):
        ...
        modified_entities = find_modified_entities(original_tree, new_tree)
        self.assertEqual(
            len(modified_entities), 0, "Trees should be identical after serialization"
        )
    ...
    def test_tuple_entity_serialization(self):
        ...
        for i, entity in enumerate(new_entity.entities):
            ...
            self.assertEqual(
                entity.root_ecs_id, self.tuple_entity.entities[i].root_ecs_id
            )
    ...
    def test_set_entity_in_registry(self):
        ...
        stored_entity = EntityRegistry.get_stored_entity(
            self.set_entity.ecs_id, self.set_entity.ecs_id
        )
        ...
        for entity in original_entities:
            ...
            stored_entity_match = next(
                (e for e in stored_entity.entities if e.ecs_id == entity.ecs_id), None
            )
            self.assertIsNotNone(
                stored_entity_match,
                f"Couldn't find entity with ecs_id {entity.ecs_id} in stored set",
            )
    ...
    def test_container_primitive_entity_serialization(self):
        ...
        self.assertEqual(
            new_entity.string_list, self.container_primitive_entity.string_list
        )
        self.assertEqual(new_entity.int_dict, self.container_primitive_entity.int_dict)
        self.assertEqual(
            new_entity.float_tuple, self.container_primitive_entity.float_tuple
        )
    ...
    def test_mixed_container_entity_serialization(self):
        ...
        self.assertEqual(
            len(new_entity.mixed_list), len(self.mixed_container_entity.mixed_list)
        )
        for i, entity in enumerate(new_entity.mixed_list):
            self.assertIsInstance(entity, Entity)
            self.assertEqual(
                entity.ecs_id, self.mixed_container_entity.mixed_list[i].ecs_id
            )

        # Check entities in dict
        self.assertEqual(
            len(new_entity.mixed_dict), len(self.mixed_container_entity.mixed_dict)
        )
        for key, entity in new_entity.mixed_dict.items():
            self.assertIsInstance(entity, Entity)
            self.assertEqual(
                entity.ecs_id, self.mixed_container_entity.mixed_dict[key].ecs_id
            )
    ...
    def test_nested_container_entity_serialization(self):
        ...
        self.assertEqual(
            new_entity.list_of_lists, self.nested_container_entity.list_of_lists
        )
        self.assertEqual(
            new_entity.dict_of_dicts, self.nested_container_entity.dict_of_dicts
        )

        # Check list of dicts with entities - this is the complex case
        self.assertEqual(
            len(new_entity.list_of_dicts),
            len(self.nested_container_entity.list_of_dicts),
        )
    ...
    def test_hierarchical_entity_serialization(self):
        ...
        self.assertEqual(
            new_entity.entity_of_entity_1.ecs_id,
            self.hierarchical.entity_of_entity_1.ecs_id,
        )
        self.assertEqual(
            new_entity.entity_of_entity_2.ecs_id,
            self.hierarchical.entity_of_entity_2.ecs_id,
        )
        self.assertEqual(
            new_entity.flat_entity.ecs_id, self.hierarchical.flat_entity.ecs_id
        )
        self.assertEqual(
            new_entity.primitive_data.ecs_id, self.hierarchical.primitive_data.ecs_id
        )
    ...
    def test_json_serialization_all_types(self):
        ...
        self.assertEqual(
            ...
            0,
            "JSON serialization should preserve all entity relationships",
        )
    ...
    def test_update_ecs_ids_serialization(self):
        ...
        self.assertIn(
            original_ecs_id, entity.old_ids, "Original ecs_id should be in old_ids"
        )
        self.assertEqual(
            entity.old_ecs_id,
            original_ecs_id,
