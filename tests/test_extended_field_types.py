...
class TestNonEntityFieldTypes(unittest.TestCase):
    ...
    def test_mixed_containers(self):
        ...
        dict_has_entity = any(
            isinstance(value, Entity) for value in entity.mixed_dict.values()
        )
    ...
    def test_nested_containers(self):
        ...
        if entity.list_of_dicts:
            ...
            has_entity_in_nested = any(
                isinstance(value, Entity) for value in first_dict.values()
            )
    ...
    def test_optional_container_handling(self):
        ...
        optional_entity_type = get_pydantic_field_type_entities(
        ...
        list_has_entity = entity.optional_entity_list and all(
            isinstance(item, Entity) for item in entity.optional_entity_list
        )
        dict_has_entity = entity.optional_entity_dict and all(
            isinstance(value, Entity) for value in entity.optional_entity_dict.values()
        )
    ...
    def test_type_detection_performance(self):
        ...
        def find_entity_in_nested_container(container):
            ...
            if isinstance(container, Entity):
                ...
                return any(
                    find_entity_in_nested_container(value)
