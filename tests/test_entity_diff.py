...
class NestedSimpleEntity(Entity):
...
class ComplexSimpleEntity(Entity):
...
class SimpleEntityDiff(unittest.TestCase):
    ...
    def test_diff_nested_attribute_changes(self):
        ...
        # Create a nested structure using our custom NestedSimpleEntity
        child = SimpleEntity()
        child.test_value = "original value"

        parent = NestedSimpleEntity()
    ...
    def test_diff_deep_hierarchy_no_changes(self):
        ...
        deep_entity2.entity_of_entity.lineage_id = (
            deep_entity.entity_of_entity.lineage_id
        )

        # For sub_entity in entity_of_entity
        deep_entity2.entity_of_entity.sub_entity.ecs_id = (
            deep_entity.entity_of_entity.sub_entity.ecs_id
        )
        deep_entity2.entity_of_entity.sub_entity.live_id = (
            deep_entity.entity_of_entity.sub_entity.live_id
        )
        deep_entity2.entity_of_entity.sub_entity.lineage_id = (
            deep_entity.entity_of_entity.sub_entity.lineage_id
        )
        ...
        self.assertEqual(
            debug_info["comparison_count"], 3
        )  # Should compare all 3 entities
    ...
    def test_diff_deep_hierarchy_leaf_change(self):
        ...
        self.assertIn(
            deep_entity2.entity_of_entity.sub_entity.ecs_id, modified_entities
        )  # Leaf
    ...
    def test_diff_multi_branch_structure_isolated_change(self):
        ...
        root.entity_of_entity_of_entity.entity_of_entity.untyped_data = (
            "deep branch middle data"
        )
        root.entity_of_entity_of_entity.entity_of_entity.sub_entity.untyped_data = (
            "deep branch leaf data"
        )
        ...
        restore_identity(
            root.entity_of_entity_1.sub_entity, root2.entity_of_entity_1.sub_entity
        )
        restore_identity(root.entity_of_entity_2, root2.entity_of_entity_2)
        restore_identity(
            root.entity_of_entity_2.sub_entity, root2.entity_of_entity_2.sub_entity
        )
        restore_identity(
            root.entity_of_entity_of_entity, root2.entity_of_entity_of_entity
        )
        restore_identity(
            root.entity_of_entity_of_entity.entity_of_entity,
            root2.entity_of_entity_of_entity.entity_of_entity,
        )
        restore_identity(
            root.entity_of_entity_of_entity.entity_of_entity.sub_entity,
            root2.entity_of_entity_of_entity.entity_of_entity.sub_entity,
        )
        ...
        self.assertIn(
            root2.entity_of_entity_2.sub_entity.ecs_id, modified_entities
        )  # Branch 2 leaf
        ...
        self.assertNotIn(
            root2.entity_of_entity_1.sub_entity.ecs_id, modified_entities
        )  # Branch 1 leaf
        self.assertNotIn(
            root2.entity_of_entity_of_entity.ecs_id, modified_entities
        )  # Deep branch
    ...
    def test_diff_performance_with_large_hierarchy(self):
        ...
        # Level 2 - Branch 1
        root.child1.branch1 = SimpleEntity()
        root.child1.branch1.test_value = "L2-B1-1"

        root.child1.branch2 = SimpleEntity()
        root.child1.branch2.test_value = "L2-B1-2"

        # Level 2 - Branch 2
        root.child2.branch1 = SimpleEntity()
        root.child2.branch1.test_value = "L2-B2-1"

        root.child2.branch2 = SimpleEntity()
    ...
    def test_diff_entity_moved_within_tree(self):
        ...
        self.assertIn(
            branch1_copy.ecs_id,
            modified_entities,
            "Branch1 where entity was removed should be modified",
        )
        ...
        self.assertIn(
            branch2_copy.ecs_id,
            modified_entities,
            "Branch2 where entity was added should be modified",
        )

        # 4. The moved entity should be detected as moved
        self.assertIn(
            movable_entity_copy.ecs_id,
            debug_info["moved_entities"],
    ...
    def test_diff_new_entity_field_addition(self):
        ...
        self.assertIn(
            root2.ecs_id,
            modified_entities,
            "Root should be modified when new entity is added",
        )

        # The new entity should be in the added entities list
        self.assertIn(
            new_child.ecs_id,
            debug_info["added_entities"],
            "New entity should be detected as added",
        )
    ...
    def test_diff_reassign_child_of_removed_entity(self):
        ...
        self.assertIn(
            middle_entity2_copy.ecs_id,
            modified_entities,
            "Middle entity 2 should be modified",
        )

        # 3. Child entity should be recognized as moved
        self.assertIn(
            child_entity_copy.ecs_id,
            debug_info["moved_entities"],
            "Child entity should be marked as moved",
        )
        ...
        self.assertIn(
            child_entity_copy.ecs_id,
            modified_entities,
            "Child entity should be marked for versioning",
        )
        ...
        self.assertTrue(
            any(
                id
                for id in debug_info["removed_entities"]
                if id != child_entity_copy.ecs_id
            ),
