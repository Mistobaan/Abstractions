...
class TestEntityContainers(unittest.TestCase):
    ...
    def test_nested_entity_hierarchy(self):
        ...
        self.assertNotEqual(
            container.ecs_id, container.entity_of_entity.sub_entity.ecs_id
        )
        self.assertNotEqual(
            container.entity_of_entity.ecs_id,
            container.entity_of_entity.sub_entity.ecs_id,
        )
    ...
    def test_hierarchical_entity(self):
        ...
        self.assertIsInstance(
            container.entity_of_entity_of_entity, EntityInEntityInEntity
        )
        ...
        self.assertIsNotNone(
            container.entity_of_entity_of_entity.entity_of_entity.sub_entity
        )
