...
from abstractions.ecs.entity import EdgeType, Entity, EntityEdge, EntityTree
...
class TestEntityTreeBasics(unittest.TestCase):
    ...
    def test_add_entity(self):
        ...
        self.assertEqual(
            self.tree.live_id_to_ecs_id[self.entity1.live_id], self.entity1.ecs_id
        )
        ...
        self.assertEqual(
            self.tree.get_entity_by_live_id(self.entity3.live_id), self.entity3
        )
    ...
    def test_add_edge(self):
        ...
        self.assertIn(
            self.entity2.ecs_id, self.tree.outgoing_edges[self.entity1.ecs_id]
        )
        self.assertIn(
            self.entity1.ecs_id, self.tree.incoming_edges[self.entity2.ecs_id]
        )
    ...
    def test_edge_type_methods(self):
        ...
        # Test tuple edge
        tuple_tree = EntityTree(
            root_ecs_id=self.root_ecs_id, lineage_id=self.lineage_id
        )
    ...
    def test_ancestry_methods(self):
        ...
        self.assertFalse(
            self.tree.is_hierarchical_edge(self.entity1.ecs_id, self.entity2.ecs_id)
        )
        self.assertFalse(
            self.tree.is_hierarchical_edge(self.entity2.ecs_id, self.entity3.ecs_id)
        )
        ...
        self.assertEqual(
            self.tree.get_hierarchical_parent(self.entity2.ecs_id), self.entity1.ecs_id
        )
        self.assertEqual(
            self.tree.get_hierarchical_parent(self.entity3.ecs_id), self.entity2.ecs_id
        )
