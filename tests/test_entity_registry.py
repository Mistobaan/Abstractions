...
class TestEntityRegistry(unittest.TestCase):
    ...
    def test_register_entity_tree(self):
        ...
        self.assertIn(
            self.root.ecs_id, EntityRegistry.lineage_registry[self.root.lineage_id]
        )

        # Check that the type_registry was updated
        self.assertIn(self.root.__class__, EntityRegistry.type_registry)
        self.assertIn(
            self.root.lineage_id, EntityRegistry.type_registry[self.root.__class__]
        )
    ...
    def test_get_stored_entity(self):
        ...
        retrieved_entity = EntityRegistry.get_stored_entity(
            self.nested.ecs_id, sub_entity.ecs_id
        )
        ...
        self.assertIsNone(
            EntityRegistry.get_stored_entity(self.nested.ecs_id, non_existent_id)
        )
    ...
    def test_version_entity_with_changes(self):
        ...
        self.root.untyped_data = (
            "Modified data with significant change to ensure detection"
        )
    ...
    def test_nested_entity_versioning(self):
        ...
        self.nested.sub_entity.untyped_data = (
            "Modified sub-entity with substantial change"
        )
    ...
    def test_complex_entity_tree(self):
        ...
        entity_of_entity_of_entity.entity_of_entity.sub_entity.root_live_id = (
            root.live_id
        )
        ...
        original_deep_sub_entity_ecs_id = (
            entity_of_entity_of_entity.entity_of_entity.sub_entity.ecs_id
        )

        # Modify a deeply nested entity
        entity_of_entity_of_entity.entity_of_entity.sub_entity.untyped_data = (
        ...
        self.assertEqual(
            root.entity_of_entity_of_entity.entity_of_entity.root_ecs_id, root.ecs_id
        )
